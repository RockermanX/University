...
<html lang="en">
    ...
    <div class="container">
      <a class="navbar-brand" href="#"> <h3 class="mb-0"><img src="{{asset('images/logo_white_xs.png')}}" alt=""></h3></a>
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
       ...
       <a class="nav-link text-white p-2 font-weight-bold" href="{{route('login')}}">Login</a>
        <a class="nav-link text-white p-2 font-weight-bold" href="{{route('register')}}">Register</a>
